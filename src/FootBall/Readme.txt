...
This program requires the use instance variables.
You will have at least 2 String variables for team names, one or two int arrays
to hold the quarter scores.
